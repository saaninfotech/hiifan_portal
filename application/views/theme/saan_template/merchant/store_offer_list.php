            ...
            <tr>
                <td>
                    ...
                    ?>
                    	...
                    	<tr>
                        	<th width="8%">Sl No.</th>
                            <th width="30%">Offer Tag Line</th>
                            <th width="28%">Date Time</th>
                            <th width="14%">Mail Send?</th>
                            <th>Action</th>
                        </tr>
                        <?   $i = 1;
                        foreach($OfferDetailsArray['result_set'] as $offerArray){
                            ...
                            <tr>
                                ...
                                <td align="center" style="color:<?=($offerArray['store_offer_issend'] == "no")?"red":"green"?>"><strong><?=ucwords($offerArray['store_offer_issend'])?></strong></td>
                                <td><?=($offerArray['store_offer_issend'] == 'no')?"$sendMailLink":""?> | <a class='red_button' style='color:#fff; font-size:10px;' href='<?=__SITE_URL?> merTransaction/view_offer_mail/offer_id:<?=$offerArray['store_offer_id']?>'>View</a></td>
                            </tr>
                            <?  $i++; }?>
