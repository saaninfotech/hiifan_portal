        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                    ...
                    <?php
                    $paginationContent = General::getFullNavigation($LoyaltyTranDetailsArray['total_rows'], $LoyaltyTranDetailsArray['total_pages'], $PresentPage, "merTransaction/loyalty_transactions");
